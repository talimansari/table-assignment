...
function App() {
  ...
  const filtredSortedData = useMemo(() => {
    let filtredData = userTableData.filter((user) => user.name.toLowerCase().includes(debouncedInput.toLowerCase()) ||
      ...
      <div className='container'>
        <div className='table-search'>
          ...
          <div className='search-wrap'><input
            ...
            placeholder='search' /><Search /></div>
        </div>
        <div className='table-wrapper'>
          <table>
            <thead>
              <tr>
                <th onClick={() => handleSort("id")}>User Id <ArrowDownUp style={{ cursor: "pointer" }} /></th>
                <th onClick={() => handleSort("name")}>Name <ArrowDownUp style={{ cursor: "pointer" }} /></th>
                <th>Address</th>
                <th>Company Name</th>
              </tr>
            </thead>
